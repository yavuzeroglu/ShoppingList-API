...
public interface IBasketService
{
  ...
  public Task<int> GetTotalBasketCountAsync(); // Kullanıcının toplam sepet sayısı

  // Commands
  public Task CreateBasketAsync(string BasketName);
  public Task AddItemToBasketAsync(int basketId, int productId, int quantity, decimal unitPrice);
  ...
  public Task DuplicateBasketAsync(int basketId, string newBasketName); // Var olan sepeti kopyalar
